/* ==========================================================================
   ...
   (function () {
    ...
    if (menuBtn) {
      var links = [
        { href: 'home-1.html', label: 'Home', icon: 'bi-house' },
        { href: 'about-us.html', label: 'About', icon: 'bi-info-circle' },
        { href: 'services.html', label: 'Services', icon: 'bi-wrench' },
        { href: 'pricing.html', label: 'Pricing', icon: 'bi-tag' },
        { href: 'blogs.html', label: 'Blog', icon: 'bi-journal-text' },
        { href: 'contact.html', label: 'Contact', icon: 'bi-telephone' }
      ];
      ...
      drawer.innerHTML =
        ...
        '<div class="mobile-drawer-cta">' +
          '<a href="contact.html" class="btn btn-primary" style="width:100%"><i class="bi bi-calendar-check"></i> Book Now</a>' +
          '<a href="login.html" class="btn btn-ghost" style="width:100%"><i class="bi bi-box-arrow-in-right"></i> Login</a>' +
        '</div>';
