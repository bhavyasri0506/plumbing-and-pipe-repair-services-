/* ==========================================================================
   ...
   (function () {
    ...
    var actions = '<div class="nav-right">' +
      '<a href="' + ROOT + 'login.html" class="btn btn-ghost" style="display:none;font-size:.85rem;padding:.5rem 1rem" id="navLogin"><i class="bi bi-box-arrow-in-right"></i> Login</a>' +
      ...
      '<a href="' + ROOT + 'contact.html" class="btn btn-primary" style="display:none;font-size:.85rem;padding:.5rem 1.1rem" id="navCta"><i class="bi bi-calendar-check"></i> Book Now</a>' +
      '</div>';
